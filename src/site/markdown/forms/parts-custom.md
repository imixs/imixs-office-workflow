...
A custom part is a HTML element located under the path <code>/pages/workitesm/parts/</code>. The location of a part can be defined in the attribute <code>path</code> of a custom input type:
</p>
