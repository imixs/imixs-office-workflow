...
@Named
@ConversationScoped
public class MinuteControllerOLD implements Serializable {
	...
	private static Logger logger = Logger.getLogger(MinuteControllerOLD.class.getName());
