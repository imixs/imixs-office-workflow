...
public class BICValidatorTest {
    ...
    void testValidBIC8_DeutscheBundesbank() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "MARKDEFF"));
    }

    @Test
    void testValidBIC8_Commerzbank() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "COBADEFF"));
    }

    @Test
    void testValidBIC11_withBranchCode() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "PALSPS22XXX"));
    }

    @Test
    void testValidBIC11_DeutscheBundesbank() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "MARKDEFFXXX"));
    }

    @Test
    void testValidBIC_withSpaces() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "MARK DEFF"));
    }
    ...
    // assertNotNull(ex.getFacesMessage());
    // assertEquals("BIC has invalid country code",
