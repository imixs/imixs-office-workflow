 ...
 * <p>
 * {@code FacesContext} and {@code UIComponent} are mocked via Mockito since the
 * validator does not interact with them beyond receiving the value.
 */
public class IBANValidatorTest {
    ...
    void testValidIBAN_DE_unformatted() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "DE91100000000123456789"));
    }

    @Test
    void testValidIBAN_GB_unformatted() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "GB82WEST12345698765432"));
    }

    @Test
    void testValidIBAN_CH_unformatted() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, "CH9300762011623852957"));
    }
    ...
    void testNullValue_noException() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, null));
    }

    @Test
    void testEmptyValue_noException() {
        assertDoesNotThrow(() -> validator.validate(facesContext, component, ""));
    }
    ...
    // assertEquals("IBAN has invalid country code",
    // ex.getFacesMessage().getSummary());
    // }
    ...
    // assertNotNull(ex.getFacesMessage());
    // assertEquals("IBAN violates ISO 7064 Mod 97-10 checksum check",
    // ex.getFacesMessage().getSummary());
    // }
    ...
    // assertNotNull(ex.getFacesMessage());
    // assertEquals("IBAN has unsupported country code",
    // ex.getFacesMessage().getSummary());
    // }
    ...
    // assertNotNull(ex.getFacesMessage());
    // assertEquals("IBAN has invalid check digits",
    // ex.getFacesMessage().getSummary());
    // }
