...
$(document).bind("mobileinit", function() {
	...
	$('#workflowgroups').live('pageshow', function(event, ui) {
		// alert('pageshow');
		// clearView();
		fetchWorkflowGroups();
	});
	...
	// Event Handler for process page on pageshow event
	$('#worklist').live('pageshow', function(event, ui) {
		// alert('pageshow');
		// clearView();
		fetchWorklist();
	});
	...
	// Event Handler for process page on pageshow event
	$('#projects').live('pageshow', function(event, ui) {
		// alert('pageshow');
		// clearView();
		fetchProjects();
	});
	...
	// Event Handler for process page on pageshow event
	$('#workitem').live('pageshow', function(event, ui) {
		// alert('pageshow');
		// clearView();
		fetchWorkitem();
	});
